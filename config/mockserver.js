...
const noelectric = ['NHDP0003', 'NHDP0004', 'NHDP0007', 'NHDP0008'];
const persentage = ['NHDP0011', 'NHDP0012', 'NHDP0015', 'NHDP0016', 'NHDP0038', 'NHDP0039'];
const point = ['NHDP0062', 'NHDP0063', 'NHDP0043', 'NHDP0048'];
...
function getCZXTData(reqStr) {
    ...
    reqArr = reqArr.map(function(ele) {
        if (persentage.includes(ele[2])) {
            ...
            return `{"accountCode":"${ele[1]}","bilMonth":"${ele[0]}","indexVlue":"${(Math.random() * 2 + 1.3).toFixed(5)}","indexCode":"${ele[2]}"}`;
        } else if (negative.includes(ele[2])) {
            // return `{"accountCode":"${ele[1]}","bilMonth":"${ele[0]}","indexVlue":"${-(Math.random() * 5000) + 10}","indexCode":"${ele[2]}"}`;
            return `{"accountCode":"${ele[1]}","bilMonth":"${ele[0]}","indexVlue":"${(Math.random() * 50) + 100}","indexCode":"${ele[2]}"}`;
        ...
        // } else if (juzhanshu.includes(ele[2])) {
            ...
            // }
        } else if (noelectric.includes(ele[2])) {
            return `{"accountCode":"${ele[1]}","bilMonth":"${ele[0]}","indexVlue":"${Math.random() * 50 + 100}","indexCode":"${ele[2]}"}`;
        } else {
...
app.listen(3000, () => {
    console.log('this is a demo request post is starting at port 3000');
});
